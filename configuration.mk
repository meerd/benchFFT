...
export REPORT_PREFIX=$(CONFIG_BENCHFFT_REPORT_PREFIX)
export MAXN=$(CONFIG_BENCHFFT_MAX_PROBLEM_SIZE)
export MAXND=$(CONFIG_BENCHFFT_MAX_MULTI_DIMENSIONAL_PROBLEM_SIZE)

export OUTPUT_FOLDER=$(if $(CONFIG_BENCHFFT_USE_OUTPUT_FOLDER),$(CONFIG_BENCHFFT_OUTPUT_FOLDER),$(ROOT_DIR))
export TEST_PROFILE_NAME="tp_$(CONFIG_BENCHFFT_TEST_PROFILE_NAME)"